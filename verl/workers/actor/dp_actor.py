...
from verl.trainer.ppo.core_algos import agg_loss, compute_policy_loss, get_policy_loss_fn, kl_penalty, compute_policy_loss_low_entropy_kl_cov,  compute_policy_loss_low_entropy_kl_cov_v2
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.policy_loss.loss_mode == "vanilla":
                        #token_entropy = verl_F.entropy_from_logits(logits)  # shape: (batch_size, response_len)
                        '''
                        ...
                        '''
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = compute_policy_loss_low_entropy_kl_cov_v2(
