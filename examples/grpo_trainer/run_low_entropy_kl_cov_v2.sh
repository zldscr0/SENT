...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='ours_low_en_kl_v2' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=10 \
    trainer.total_epochs=5 $@ \
    >> /root/bayes-tmp/bzx_data/code/verl_tmp/verl/logs/Deepseek-R1-Distill-Qwen-1.5B-DAPO-17k/ours_low_en_kl_v2.log 2>&1