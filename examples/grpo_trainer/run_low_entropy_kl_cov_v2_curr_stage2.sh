...
dapo_train_path=/data1/wym_data/data/dapo-math-0802/math_entropy2.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/home/wym/bzx/verl/hf_model/ours_low_en_kl_v2_curriculum_stage1 \
    ...
    >> logs/ours_low_en_kl_v2_curriculum.log 2>&1