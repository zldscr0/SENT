...
#math_train_path=/root/bayes-tmp/bzx_data/data/math/train.parquet
#math_test_path=/root/bayes-tmp/bzx_data/data/math/test.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/root/bayes-tmp/bzx_data/llm/DeepSeek-R1-Distill-Qwen-1.5B \
    ...
    trainer.experiment_name='qwen_highentropy_test' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=10 \
    trainer.total_epochs=5 $@ \
    >> logs/qwen_highentropy_test.log 2>&1